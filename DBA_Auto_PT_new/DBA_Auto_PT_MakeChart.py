...
for reportfile in reportfile_list:
	...
	if Write_title_flag == 0:
		if rate_param == "M":
			os.system("echo 'Version,tcpreplay_rate/Mbps,expect_count/s,sga_count/s,trace_count/s,index_count/s,summary_count/s' > %s/%s"%(CHART_REPORTS_DIR,Diff_Rate_csvfile))	
		elif rate_param == "p":
			os.system("echo 'Version,tcpreplay_rate/pps,expect_count/s,sga_count/s,trace_count/s,index_count/s,summary_count/s' > %s/%s"%(CHART_REPORTS_DIR,Diff_Rate_csvfile))	
